...
local title3Group = display.newGroup()
-- 게임설명창

	title = display.newImage(title3Group,"images/title.png", 1280, 720)
	title.x, title.y = display.contentWidth*0.5, display.contentHeight*0.5
	titleMsg = display.newImage(title3Group,'images/titleMsg2.png')
...
local playBtn = display.newImage('images/playBtn.png', display.contentCenterX, display.contentCenterY+210)
	...
	local function playing(event)
		composer.removeScene("ministory3")
		composer.gotoScene("subGame3")
	end
